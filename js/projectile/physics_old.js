...
function Input(){
  ...
  var v = parseFloat(prompt("What is the initial velocity of the projectile\nInput in m/s"));
  var c = parseFloat(prompt("What is the initial height the projectile is thrown from\nInput in metres")); 
  var g = 10; //Here the code sets acceleration due to 10, but it can be changed to 9.81
